...
class Colors {
  Color _mainColor = Color(0xFF003049);
  Color _mainDarkColor = Color(0xFFD62828);
  Color _secondColor = Color(0xFF003049);
  Color _secondDarkColor = Color(0xFFccccdd);
  Color _accentColor = Color(0xFF003049);
  Color _accentDarkColor = Color(0xFF9999aa);
  Color _scaffoldDarkColor = Color(0xFF2C2C2C);
  Color _scaffoldColor = Color(0xFFeeeeee);
